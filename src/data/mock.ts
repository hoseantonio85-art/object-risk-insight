...
export const objects: ObjectItem[] = [
  ...
  { id: "p6", name: "Цифровой вклад", type: "product", riskLevel: "medium", status: "progress", lastAssessment: null, description: "Новый депозитный продукт с гибкими условиями", lifecycle: "planned", evaluationStatus: "needs-review" },
  { id: "p7", name: "Семейная подписка", type: "product", riskLevel: "low", status: "none", lastAssessment: null, description: "Пакетное предложение для семейных клиентов", lifecycle: "planned", evaluationStatus: "ai-analysis" },
